    ...
    public partial class MigracionDatos : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PlanRecompensasId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlanRecompensas", x => x.PlanRecompensasId);
                    table.ForeignKey(
                        name: "FK_PlanRecompensas_Cliente_ClienteId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlanRecompensas_ClienteId",
