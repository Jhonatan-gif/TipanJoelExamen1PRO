...
namespace TipanExamen.Controllers
{
    public class ReservasController : Controller
    {
        ...
        public ReservasController(TipanData context)
        {
            _context = context;
        }
        ...
        {
            var tipanData = _context.Reserva.Include(r => r.Cliente);
        ...
        public async Task<IActionResult> Create([Bind("ReservaId,FechaEntrada,FechaSalida,ValorPagar,ClienteId")] Reserva reserva)
        {
            ...
            ViewData["ClienteId"] = new SelectList(_context.Cliente, "ClienteId", "Correo", reserva.ClienteId);
            return View(reserva);
        }
